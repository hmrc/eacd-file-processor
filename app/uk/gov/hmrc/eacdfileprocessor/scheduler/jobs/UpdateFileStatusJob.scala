...
import uk.gov.hmrc.eacdfileprocessor.services.UpdateFileStatusService

import javax.inject.Inject

class UpdateFileStatusJob @Inject()(val config: Configuration,
                                     val updateFileStatusService: UpdateFileStatusService) extends ScheduledJob {

  val jobName: String           = "UpdateFileStatusJob"
