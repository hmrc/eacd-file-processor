...
trait TestData:
  ...
  val statusDetailsModel = StatusDetailsModel(reference = "08aad019-7f66-4456-8d52-93f12109876f", approverEmail = "test@hmrc.gov.uk", approverPID = "12345678", name = Some("test.pdf"), status = "SCANNED", uploadedDateTime = Some(createdAt))
